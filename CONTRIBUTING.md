...
Submit feature ideas as a PR adding a `.txt` or `.md` file to the [`adrs/`](adrs/) folder.

For bugs, open an issue with enough information to reproduce the problem. We'll reference your report when we merge a fix.
