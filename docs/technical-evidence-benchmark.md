...
That record validates the earlier candidate-review prompt, not the prompt-version-8 evidence-investigation, bounded-retrieval, and isolated-test interpretation schema. A two-target smoke fixture passed the new grounded-claim, assurance, retrieval, and malformed-plan fallback contract on 2026-08-06, but the historical 17-candidate figures cannot be applied to it until the full representative live benchmark is rerun.
