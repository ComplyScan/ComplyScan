...
The cache-bypassed wall times were 513.8 seconds for Go and 495.1 seconds for Python on 2026-08-07. The original TypeScript wall-clock measurement was discarded because the host laptop slept while `/usr/bin/time` continued measuring. A controlled awake TypeScript rerun on 2026-08-08 passed the same six decisions in 592.9 seconds with no semantic correction. Peak ComplyScan CLI resident size across these recorded runs was approximately 19.3 MB. The loaded Ollama model allocation remained 5.6 GB at a 4,096-token context. Source-free reports and metrics were saved locally under `.complyscan/validation/ollama/` with timestamps `20260807T221544Z`, `20260807T222506Z`, and `20260808T063717Z` and remain Git-ignored.
